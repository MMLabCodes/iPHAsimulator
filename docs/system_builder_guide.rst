system_builder guide
====================

This module is the basis for almost all of the tasks carried out by other modules in this package. It relies on the **PolySimManage** class in the **filepath_manager** module
for a lot of file finding and directing.

The second and third tutorials (**Tutorial_2_Parameterizing_Small_Molecules_and_Polymers** and **Tutorial_3_Solvating_Small_Molecules_and_Polymers**) provides a nice introduction into how to use this module and carry out a range of tasks related to building molecules and generating AMBER files for molecular dynamics.
...
The **BuildSystems** class gives access to a range of standard functions. Before going through some examples lets initialise an instance of this class; an instance of the **PolySimManage** class will also need to be initiated as explained in the **filepath_manager guide**.
