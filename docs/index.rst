...
- **Introduction** – Overview of the project, its purpose, and key features.
- **Installation** – Step-by-step instructions to get up and running.
- **Package Contents** – A summary of the modules and tools included.
- **Simulating PHAs** – Tutorials for building and simulating polyhydroxyalkanoate systems.
- **Analysis** – Post-processing and trajectory analysis workflows.
- **Modules** – In-depth documentation of each module and API reference.
