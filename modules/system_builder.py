...
# Module Constants
FORBIDDEN_RESIDUE_CODES: List[str] = [
    "AAA", "BBB", "CCC", "UNL", "ALA", "ARG", "ASN", "ASP", "ASX",
    "CYS", "GLU", "GLN", "GLX", "HIS", "ILE", "LEU", "LYS", "MET",
    "PHE", "PRO", "SER", "THR", "SEC", "TRP", "TYR", "VAL"
]
...
class BuildSystems():
    ...
    Attributes:
        ...
        packmol_path (property): Path to the Packmol executable (from config)
    """
    ...
    def __init__(self, manager):
        ...
        self._packmol_path = None

    @property
    def packmol_path(self) -> str:
        """Get path to packmol executable from configuration."""
        if self._packmol_path is None:
            from modules.config import get_packmol_path
            self._packmol_path = get_packmol_path()
        return self._packmol_path
