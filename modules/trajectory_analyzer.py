...
from modules.molecule_builder import estimated_volume, volume_model
...
# Module Constants
DEFAULT_BINS: int = 25
DEFAULT_ROG_BINS: int = 50
DEFAULT_CUTOFF: float = 6.0  # Angstroms
DEFAULT_FRAME_STEP: int = 1

# Analysis method constants
ROG_ANALYSIS_MODE: str = "backbone"
END_TO_END_ANALYSIS_MODE: str = "all"
PERSISTENCE_LENGTH_METHOD: str = "msd"
